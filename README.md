...
Check what changed in the repository:

```bash
clab@ubuntu:~/emea-ambassadors-containerlab-aug-2022$ git status
On branch main
Your branch is up to date with 'origin/main'.

Untracked files:
  (use "git add <file>..." to include in what will be committed)
    .ambassadors_default_cfg.clab.yml.bak
    clab-ambassadors_clab/
...
```bash
clab@ubuntu:~/emea-ambassadors-containerlab-aug-2022$ git add *
